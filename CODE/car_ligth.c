...
/* rgb颜色定义 */
 unsigned char rgb_off[3] = {0x00,0x00,0x00};
 unsigned char rgb_blue[3] = {0x00,0x00,0xFF};
 unsigned char rgb_green[3] = {0x00,0xFF,0x00};
 unsigned char rgb_cyan[3] = {0x00,0xFF,0xFF};
 unsigned char rgb_red[3] = {0xFF,0x00,0x00};
 unsigned char rgb_purple[3] = {0xFF,0x00,0xFF};
 unsigned char rgb_yellow[3] = {0xFF,0xFF,0x00};
